...
<div class="container productlistCon mshow">
    <?php foreach ($products as $product) { ?>
    <div class="row productlist">
        <table>
            <tr class="producttr" data-href = "<?php echo $product['href']; ?>">
                <td style="width: 30%;">
                    <a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>"
                                                                   class="img-responsive"></a>
                </td>
                <td>
                    <a href="<?php echo $product['href']; ?>"><p class="producttitle"><?php echo $product['name']; ?></p></a>

                    <p class="money"><img src="image/catalog/newstyle/rmbicon.png"
                                          class="rmbicon"/>100</p><!--<?php echo $product['price']; ?>-->
                    <table>
                        <tr>
                            <td>
                                <p class="time"><span class="glyphicon glyphicon-thumbs-up"></span>&nbsp;259条好评</p>
                            </td>
                            <td style="text-align: right">
                                <img src="image/catalog/newstyle/favoriteicon.png" class="favoriteicon"/>
                            </td>
                        </tr>
                    </table>
                </td>
