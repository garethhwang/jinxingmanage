...
<div class="container productlistCon mshow " style="background-color: #f7f7f7">
    <div class="row" style="background-color: white">
        <div id="myCarousel" class="carousel">
            ...
            <!-- 轮播（Carousel）项目 -->
            <div class="carousel-inner slide" align="center">
                <?php if ($thumb || $images) { ?>
                <?php if ($images) { ?>
                <div class="item active">
                    <img style="width: 100%" src="<?php echo $images[0]['thumb']; ?>" alt="First slide">
                </div>
                <?php for($x=1; $x<count($images); $x++) { ?>
                <div class="item">
                    <img style="width: 100%" src="<?php echo $images[$x]['thumb']; ?>" alt="First slide">
                </div>
                <?php } ?>
                <?php } ?>
                <!--<ul class="thumbnails">
    ...
    <div class="row" style="height: 0.05rem;background-color: #e6e6e6"></div>
    <div class="row" style="background-color: white">
        <div class="col-xs-6 text-left">
            <label style="margin-top: 1rem;font-size:2rem">产后开奶</label>
        </div>
        <div class="col-xs-6 text-right">
            <img src="image/catalog/newstyle/rmbicon.png" style="width: 1.5rem;margin-top: -0.7rem"><label
                    style="color: #F27863;font-size: 2.5rem;padding-top: 0.5rem"><?php echo $special; ?></label>
        </div>
    </div>
    <div class="row" style="margin-bottom: 1rem;height: 0.05rem;background-color: #e6e6e6"></div>
    <div class="row" style="height: 0.05rem;background-color: #e6e6e6"></div>
    <div class="row" style="background-color: white">
        <div class="col-xs-12 text-left">
            <label style="color: #F27863;margin-top: 1rem;">项目介绍</label>
        </div>
    </div>
    <div class="row" style="height: 0.05rem;background-color: #e6e6e6;margin-left: 0.5rem;margin-right: 0.5rem"></div>
    <div class="row" style="background-color: white;margin-bottom: 0rem">
        <div class="col-xs-12 text-left">
            <p style="margin-top: 1rem;font-size: 1.2rem"><?php echo $description; ?></p>
        </div>
    </div>
    <div class="row" style="background-color: white;margin-bottom: 0rem">
        <div class="col-xs-12 text-center">
            <input type="button" id="PayProduct" onclick="callpay()"  value="支 付" style="width: 10rem;height: 3rem"/>
        </div>
    </div>
</div>
<script type="text/javascript">
