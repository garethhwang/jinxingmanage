        ...
        <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <fieldset id="physical">
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-bmitype" ><?php echo $entry_bmiindex; ?></label>
                        <div class="col-sm-10">
                            <label id="bmiindex" class="form-control"></label>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <label id="bmitype"  class="form-control"></label>
                ...
                <fieldset id="address">
                    ...
                    <!--div class="form-group">
                        <label class="col-sm-2 control-label"
                               for="input-address-2"><?php echo $entry_address_2; ?></label>
                        <div-- class="col-sm-10">
                            <input type="text" name="address_2" value="<?php echo $address_2; ?>"
                                   placeholder="<?php echo $entry_address_2; ?>" id="input-address-2"
                                   class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                               for="input-postcode"><?php echo $entry_postcode; ?></label>
...
<script type="text/javascript">
    function countindex() {
        ...
        document.getElementById("bmiindex").innerHTML = bmiindex;

        if(bmiindex<"18.5"){

           // echo "过轻"; $bmitype = "0";
            document.getElementById("bmitype").innerHTML = "过轻";
        }
        else if(bmiindex<"25"){
            //echo "正常"; $bmitype = "1";
            document.getElementById("bmitype").innerHTML = "正常";
        }
        else if(bmiindex<"28"){
            //echo "过重"; $bmitype = "2";
            document.getElementById("bmitype").innerHTML = "过重";
        }
        else if(bmiindex<"32"){
            //echo "肥胖"; $bmitype = "3";
            document.getElementById("bmitype").innerHTML = "肥胖";
        }
        else{
            //echo "非常肥胖"; $bmitype = "4";
            document.getElementById("bmitype").innerHTML = "非常肥胖";
        }
