    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <!--div class="form-group required">
            <label class="col-sm-2 control-label" for="input-productiondate"><?php echo $entry_productiondate; ?></label>
            <div class="col-sm-10">
              <input type="datetime" name="productiondate" value="<?php echo $productiondate; ?>" placeholder="<?php echo $entry_productiondate; ?>" id="input-productiondate" class="form-control" />
              <?php if ($error_productiondate) { ?>
              <div class="text-danger"><?php echo $error_productiondate; ?></div>
              <?php } ?>
            </div>
          </div-->
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-department"><?php echo $entry_department; ?></label>
            <div class="col-sm-10">
              <input type="text" name="department" value="<?php echo $department; ?>" placeholder="<?php echo $entry_department; ?>" id="input-department" class="form-control" />
