      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="householdregister" value="<?php echo $householdregister; ?>" placeholder="<?php echo $entry_householdregister; ?>" id="input-householdregister" class="form-control" />
            </div>
          </div>
          <div class="form-group required">
