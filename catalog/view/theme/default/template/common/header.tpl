...
<head>
    ...
    <link href="catalog/view/theme/default/stylesheet/wechatstyle.css" rel="stylesheet"/>
    <script src="catalog/view/javascript/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="catalog/view/javascript/wechat/wechatfunction.js" type="text/javascript"></script>
    <link href="catalog/view/javascript/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
    <link href="//fonts.googleapis.com/css?family=Open+Sans:400,400i,300,700" rel="stylesheet" type="text/css"/>
    <link href="catalog/view/theme/default/stylesheet/stylesheet.css" rel="stylesheet">
    <link href="catalog/view/theme/default/stylesheet/stylesheetm.css" rel="stylesheet">
...
<div class="headnav mshow">
    <table>
        <tr>
            <td style="text-align: left;">
                &nbsp;&nbsp;北京&nbsp;<span class="glyphicon glyphicon-chevron-down"></span>
            </td>
            <td style="text-align: right;">
            </td>
            <td style="text-align: right;" id="wishlist" data-href="index.php?route=account/wishlist">
                <img src="image/catalog/newstyle/favorite.png"/>&nbsp;收藏&nbsp;&nbsp;
            </td>
        </tr>
    </table>
</div>
<div class="headblock mshow"></div>
<nav id="top" class="mnotshow">
    <div class="container">
        <?php echo $currency; ?>
        <?php echo $language; ?>
...
<?php if ($categories) { ?>
<div class="container">
    <nav id="menu" class="navbar mnotshow">
