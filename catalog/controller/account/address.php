...
class ControllerAccountAddress extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_householdregister'] = $this->language->get('entry_householdregisterv');
		...
		if (isset($this->request->post['realname'])) {
			...
			$data['realname'] = $address_info['realname'];
		} else {
			$data['realname'] = '';
		}
		...
		if (isset($this->request->post['householdregister'])) {
			...
			$data['householdregister'] = $address_info['householdregister'];
		} else {
	...
	protected function validateForm() {
		...
		if ((utf8_strlen(trim($this->request->post['householdregister'])) < 1) || (utf8_strlen(trim($this->request->post['householdregister'])) > 32)) {
			$this->error['householdregister'] = $this->language->get('householdregister');
		}
