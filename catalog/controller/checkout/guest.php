...
class ControllerCheckoutGuest extends Controller {
	public function index() {
		...
		if (isset($this->session->data['guest']['realname'])) {
			$data['realname'] = $this->session->data['guest']['realname'];
		} else {
			$data['realname'] = '';
		}
		...
		if (isset($this->session->data['payment_address']['householdregister'])) {
			$data['householdregister'] = $this->session->data['payment_address']['householdregister'];
		} else {
	...
	public function save() {
		...
		if (!$json) {
			if ((utf8_strlen(trim($this->request->post['realname'])) < 1) || (utf8_strlen(trim($this->request->post['realname'])) > 32)) {
				$json['error']['realname'] = $this->language->get('error_realname');
			}
		...
		if (!$json) {
			...
			$this->session->data['guest']['realname'] = $this->request->post['realname'];
			...
			$this->session->data['payment_address']['realname'] = $this->request->post['realname'];
			$this->session->data['payment_address']['householdregister'] = $this->request->post['householdregister'];
			...
			if ($this->session->data['guest']['shipping_address']) {
				$this->session->data['shipping_address']['realname'] = $this->request->post['realname'];
				$this->session->data['shipping_address']['householdregister'] = $this->request->post['householdregister'];
