...
class ControllerCheckoutGuestShipping extends Controller {
	public function index() {
		...
		if (isset($this->session->data['shipping_address']['realname'])) {
			$data['realname'] = $this->session->data['shipping_address']['realname'];
		} else {
			$data['realname'] = '';
		}

		if (isset($this->session->data['shipping_address']['householdregister'])) {
			$data['householdregister'] = $this->session->data['shipping_address']['householdregister'];
		} else {
