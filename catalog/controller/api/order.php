	...
	public function add() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if (!$json) {
				...
				$order_data['realname'] = $this->session->data['customer']['realname'];
				...
				if ($this->cart->hasShipping()) {
                    ...
                    $order_data['shipping_date'] = $this->session->data['shipping_address']['shipping_date'];
                    ...
                    $log = new Log('api.log');
                    $log->write('address_1');
                    $log->write($this->session->data['shipping_address']['address_1']);
                    $log->write('shipping_date');
                    $log->write($this->session->data['shipping_address']['shipping_date']);
