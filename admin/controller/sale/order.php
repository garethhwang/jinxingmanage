...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
        ...
        $data['entry_shipping_date'] = $this->language->get('entry_shipping_date');
		...
		if (!empty($order_info)) {
			...
			$data['realname'] = $order_info['realname'];
			...
			$data['payment_realname'] = $order_info['payment_realname'];
			...
			$data['shipping_realname'] = $order_info['shipping_realname'];
			...
			$data['affiliate'] = $order_info['affiliate_realname'];
		...
		$log=new Log('api.log');
		$log->write($this->config->get('config_api_id'));
	...
	public function info() {
		...
		if ($order_info) {
			...
			$replace = array(
                ...
                'shipping_date' => $order_info['shipping_date'],
			...
			$data['affiliate_realname'] = $order_info['affiliate_realname'];
