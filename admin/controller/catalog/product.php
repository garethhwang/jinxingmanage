...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_service_timer'] = $this->language->get('entry_service_timer');
		$data['entry_meta_title'] = $this->language->get('entry_meta_title');
        $data['entry_service_notes'] = $this->language->get('entry_service_notes');
        $data['entry_applicable_user'] = $this->language->get('entry_applicable_user');
		...
		if (isset($this->request->post['service_timer'])) {
			$data['service_timer'] = $this->request->post['service_timer'];
		} elseif (!empty($product_info)) {
			$data['service_timer'] = $product_info['service_timer'];
		} else {
			$data['service_timer'] = 0;
		}
