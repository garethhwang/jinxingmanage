...
class ControllerUserUser extends Controller {
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['filter_province_id'])) {
            $filter_province_id = $this->request->post['filter_province_id'];
        ...
        if (isset($this->request->post['filter_city_id'])) {
            $filter_city_id = $this->request->post['filter_city_id'];
        ...
        if (isset($this->request->post['filter_district_id'])) {
            $filter_district_id = $this->request->post['filter_district_id'];
        ...
        if (isset($this->request->post['filter_office_id'])) {
            $filter_office_id = $this->request->post['filter_office_id'];
        } else {
        ...
        var_dump($data['filter_office_id']);
