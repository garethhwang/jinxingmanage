...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
            ...
            if ($this->user->hasPermission('access', 'clinic/clinic')) {
                $clinic[] = array(
                    'name'	   => $this->language->get('text_clinic'),
                    'href'     => $this->url->link('clinic/clinic', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
			...
			*/	
            ...
            if ($this->user->hasPermission('access', 'advice/advice')) {
                $advice[] = array(
                    'name'	   => $this->language->get('text_advice'),
                    'href'     => $this->url->link('advice/advice', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
