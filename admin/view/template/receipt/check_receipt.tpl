                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-left" <?php if ($receipt['urgency'] == 1){ echo 'color="green"'; } else if ($receipt['urgency'] == 2) { echo 'color="orange"';} else if ($receipt['urgency'] == 3) { echo 'color="red"';}?>><?php echo $receipt['days']; echo"天"; ?></td>
                            </tr>
                            <?php } ?>
                            <?php } else { ?>
                            <tr>
