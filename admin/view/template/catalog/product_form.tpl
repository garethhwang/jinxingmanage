        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-service-notes<?php echo $language['language_id']; ?>"><?php echo $entry_service_notes; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][service_notes]" rows="5" placeholder="<?php echo $entry_service_notes; ?>" id="input-service-notes<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['service_notes'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-applicable-user<?php echo $language['language_id']; ?>"><?php echo $entry_applicable_user; ?></label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][applicable_user]" rows="5" placeholder="<?php echo $entry_applicable_user; ?>" id="input-applicable-user<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['applicable_user'] : ''; ?></textarea>
                    </div>
                  </div>
                </div>
                <?php } ?>
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-service-timer"><?php echo $entry_service_timer; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="service_timer" value="<?php echo $service_timer; ?>" placeholder="<?php echo $entry_service_timer; ?>" id="input-service-timer" class="form-control" />
                </div>
              </div>
            </div>
