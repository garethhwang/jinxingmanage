                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                      ...
                      <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-realname<?php echo $address_row; ?>"><?php echo $entry_realname; ?></label>
                        <div class="col-sm-10">
                          <input type="text" name="address[<?php echo $address_row; ?>][realname]" value="<?php echo $address['realname']; ?>" placeholder="<?php echo $entry_realname; ?>" id="input-realname<?php echo $address_row; ?>" class="form-control" />
                          <?php if (isset($error_address[$address_row]['realname'])) { ?>
                          <div class="text-danger"><?php echo $error_address[$address_row]['realname']; ?></div>
                          <?php } ?>
                        </div>
                      </div>
                      <div class="form-group">
...
function addAddress() {
	...
	html += '    <label class="col-sm-2 control-label" for="input-realname' + address_row + '"><?php echo $entry_realname; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][realname]" value="" placeholder="<?php echo $entry_realname; ?>" id="input-realname' + address_row + '" class="form-control" /></div>';
	html += '  </div>';
