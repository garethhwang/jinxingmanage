          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-customer">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="realname" value="<?php echo $realname; ?>" id="input-realname" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="payment_address" id="input-payment-address" class="form-control">
                    ...
                    <option value="<?php echo $address['address_id']; ?>"><?php echo $address['realname'] . ', ' . $address['address_1'] . ', ' . $address['city'] . ', ' . $address['country']; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-payment-realname"><?php echo $entry_realname; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="realname" value="<?php echo $payment_realname; ?>" id="input-payment-realname" class="form-control" />
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-shipping">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-shipping-realname"><?php echo $entry_realname; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="realname" value="<?php echo $shipping_realname; ?>" id="input-shipping-realname" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-shipping-date"><?php echo $entry_shipping_date; ?></label>
                <div class="col-sm-10">
                  <div class="input-group datetime">
                    <input type="text" name="shipping_date" value="<?php echo $shipping_date; ?>" data-date-format="YYYY-MM-DD HH:MM" id="input-shipping-date" class="form-control">
                    <span class="input-group-btn">
                      <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                    </span>
                  </div>
...
$('input[name=\'customer\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#tab-customer input[name=\'realname\']').val(item['realname']);
		...
		for (i in  item['address']) {
			html += '<option value="' + item['address'][i]['address_id'] + '">' + item['address'][i]['realname'] + ', ' + item['address'][i]['address_1'] + ', ' + item['address'][i]['city'] + ', ' + item['address'][i]['country'] + '</option>';
		}
...
$('select[name=\'payment_address\']').on('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			$('#tab-payment input[name=\'realname\']').val(json['realname']);
...
$('select[name=\'shipping_address\']').on('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			$('#tab-shipping input[name=\'realname\']').val(json['realname']);
			$('#tab-shipping input[name=\'lastname\']').val(json['lastname']);
			$('#tab-shipping input[name=\'company\']').val(json['company']);
            $('#tab-shipping input[name=\'shipping_date\']').val(json['shipping_date']);
